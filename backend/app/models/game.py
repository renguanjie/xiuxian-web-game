"""游戏模型"""
from sqlalchemy import Column, Integer, String, Text, JSON, DECIMAL, TIMESTAMP, Index, Enum
...
class Game(Base):
    ...
    status = Column(Enum("active", "maintenance", "hidden", "archived"), nullable=False, default="active")
    ...
    avg_score = Column(DECIMAL(10, 2), nullable=False, default=0.00, comment="平均分数")
