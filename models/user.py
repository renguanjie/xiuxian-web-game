"""用户模型"""
from sqlalchemy import Column, Integer, String, SmallInteger, TIMESTAMP, Index, ForeignKey, func
...
class User(Base):
    ...
    role_id = Column(Integer, ForeignKey("roles.id", ondelete="CASCADE"), nullable=False, default=3, comment="角色ID")
